...
overlay_two = BitemporalScenario("overlay_two", _overlay_two, "delta")
overlay_multiple = BitemporalScenario("overlay_multiple", _overlay_multiple, "delta")
multi_intersection_single_point = BitemporalScenario("multi_intersection_single_point", _multi_intersection_single_point, "delta")
multi_intersection_multiple_point = BitemporalScenario("multi_intersection_multiple_point", _multi_intersection_multiple_point, "delta")
multi_field = BitemporalScenario("multi_field", _multi_field, "delta")
extend_current_row = BitemporalScenario("extend_current_row", _extend_current_row, "delta")
extend_update = BitemporalScenario("extend_update", _extend_update, "delta")
no_change_with_intersection = BitemporalScenario("no_change_with_intersection", _no_change_with_intersection, "delta")
